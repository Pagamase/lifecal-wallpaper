...
export async function GET(req: Request) {
  ...
  // FINES DE SEMANA (lo que pides)
  // Sábado: gris más oscuro (en pasado y futuro, con dos intensidades para que se note siempre)
  const pastSaturday = "#b8b8ba";
  const futureSaturday = "#1e1e20";

  // Domingo: rojo (en pasado y futuro)
                ...
                >
                  ...
                  >
                    {Array.from({ length: paddedTotal }).map((_, idx) => {
                      ...
                      // Hoy: naranja (tiene prioridad sobre el color del día)
                      if (isToday) {
